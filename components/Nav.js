...
export default function Nav({show, setShow}) {
    const inactiveLink = 'flex gap-1 p-1 text-stone-300';
    const activeLink = 'bg-bgActive text-white rounded-sm w-full flex gap-1 p-1';
            ...
            <nav className="flex flex-col gap-3" onClick={handleClick}>
                ...
                <Link href={'/'} className={pathname === '/' ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                         stroke="#008080" className="w-6 h-6">
                ...
                <Link href={'/products'} className={pathname.includes('/products') ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                         stroke="#00FFFF" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <Link href={'/categories'} className={pathname.includes('/categories') ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                         stroke="#3cb371" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <Link href={'/orders'} className={pathname.includes('/orders') ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                         stroke="#ee82ee" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <Link href={'/admins'} className={pathname.includes('/admins') ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                         stroke="#ffa500" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <Link href={'/settings'} className={pathname.includes('/settings') ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                         stroke="#6a5acd" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <button onClick={logOut} className={inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                         stroke="#ff0000" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round"
